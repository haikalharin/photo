...
public final class FragmentVideosBinding implements ViewBinding {
  ...
  private FragmentVideosBinding(@NonNull ConstraintLayout rootView,
      @NonNull ProgressBar progressBar, @NonNull RecyclerView rvVideos) {
  ...
  public static FragmentVideosBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentVideosBinding((ConstraintLayout) rootView, progressBar, rvVideos);
    }
