...
public final class FragmentReviewBinding implements ViewBinding {
  ...
  private FragmentReviewBinding(@NonNull NestedScrollView rootView,
      @NonNull ProgressBar progressBar, @NonNull RecyclerView rvReviews) {
  ...
  public static FragmentReviewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentReviewBinding((NestedScrollView) rootView, progressBar, rvReviews);
    }
