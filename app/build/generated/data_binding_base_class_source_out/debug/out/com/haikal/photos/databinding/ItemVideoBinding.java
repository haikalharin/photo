...
public final class ItemVideoBinding implements ViewBinding {
  ...
  private ItemVideoBinding(@NonNull MaterialCardView rootView, @NonNull WebView wvVideo) {
    this.rootView = rootView;
    this.wvVideo = wvVideo;
  }
  ...
  public static ItemVideoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.wv_video;
      WebView wvVideo = ViewBindings.findChildViewById(rootView, id);
      if (wvVideo == null) {
        break missingId;
      }

      return new ItemVideoBinding((MaterialCardView) rootView, wvVideo);
    }
